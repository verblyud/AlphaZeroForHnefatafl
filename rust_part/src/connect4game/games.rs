...
use crate::connect4game::game::{check_linear_pattern, Board, Checker, chip::ChipDescrip, Game, Player, PlayerType};
use crate::connect4game::io::{BLK, BLU, BRIGHTEN, FILLED, RED, YEL};
use std::rc::Rc;
